...
<template>
  <div>
    ...
    <div class="col" style="gap: 12px">
      ...
      <template v-else>
        <div class="terms-box">
          <label class="checkbox" style="font-size: var(--fz-lg); font-weight: 600; color: var(--ink-900)">
      ...
      <div style="text-align: center; font-size: var(--fz-sm); color: var(--ink-500); margin-top: 6px">
        이미 계정이 있으신가요?
