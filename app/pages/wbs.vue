...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    emoji: '🛠️',
    name: '서비스 개발',
    summary: '아키텍처 · DB · 사용자단 · 관리자단 · API · 통합 — 실제 진행 기준으로 재구성',
    weight: 45,
    progress: 55,
    tasks: [
      /* 5-1 설계 및 준비 */
      ...
      { id: '5-2-11', group: 'API 서버', title: 'Export 잡 (다운로드 요청)', status: 'in_progress', owner: '김도형', note: '/export-jobs CRUD ✅, 처리 worker + R2 미. DDL 적용 보류(1105)' },
      { id: '5-2-12', group: 'API 서버', title: 'Flow 정의 (복합 발송)', status: 'in_progress', owner: '김도형', note: 'TB_FLOW_* 3 테이블 + /flow-definitions CRUD ✅, 실행 엔진 미. DDL 적용 보류' },
      ...
      /* 5-3 사용자단 화면 개발 */
      { id: '5-3-1', group: '사용자단 화면', title: '인증·계정 — 로그인 / 회원가입 5단계 / 비번 재설정 / 보안 인증', status: 'done', owner: '김도형', note: '/login · /login/security · /reset-password · /reset-password/new · /signup' },
      { id: '5-3-2', group: '사용자단 화면', title: '발송 6채널 (SMS/RCS/Kakao/Email/Push/Flow)', status: 'done', owner: '김도형', note: '/send/* + PU 풀세트(수신자·주소록·광고수신·컨펌·초기화)' },
      { id: '5-3-3', group: '사용자단 화면', title: '이력 / 통계 — 5채널 + 통계 대시보드', status: 'done', owner: '김도형', note: '/history/* + 비동기 다운로드 요청 패턴' },
      { id: '5-3-4', group: '사용자단 화면', title: '주소록 — 연락처 / 그룹 / 수신거부', status: 'done', owner: '김도형', note: '/contacts/{list,groups,optout}' },
      { id: '5-3-5', group: '사용자단 화면', title: '발신 정보 6종', status: 'done', owner: '김도형', note: '/sender/{numbers,brands,domains,push-cert,profiles,optout-080} + 등록 마법사' },
      { id: '5-3-6', group: '사용자단 화면', title: '템플릿 관리 — 5채널 + 발송 상세 설정', status: 'done', owner: '김도형', note: '/manage/{sms,rcs,kakao,email,push,settings}' },
      { id: '5-3-7', group: '사용자단 화면', title: '캠페인 — 본안 + 변형(v3)', status: 'done', owner: '김도형', note: '/campaign · /campaign3' },
      { id: '5-3-8', group: '사용자단 화면', title: '크레딧 / 결제 — 충전·결과·내역·영수증·카드 관리', status: 'done', owner: '김도형', note: '/charge · /charge/result · /account/{credit,cards}' },
      { id: '5-3-9', group: '사용자단 화면', title: '문의 — 작성 / 완료 / 내 문의 / 상세', status: 'done', owner: '김도형', note: '/inquiry · /inquiry/complete · /account/inquiries(/detail)' },
      { id: '5-3-10', group: '사용자단 화면', title: '나의 페이지 — 9 라우트', status: 'done', owner: '김도형', note: 'AppMyPageShell + /account/{settings,cards,password,security,multi,contract,credit,billing,inquiries}' },
      { id: '5-3-11', group: '사용자단 화면', title: '메시지 관리 랜딩페이지', status: 'done', owner: '김도형', note: '목록 · 기본형/확장형 등록 폼 · 미리보기' },
      ...
      { id: '5-5-4', group: '통합 · 배포', title: 'DDL — 0002_export_flow.sql 적용', status: 'blocked', owner: '김도형', note: 'Cloudflare 1105 회복 후 /admin/migrate로 적용 예정' },
