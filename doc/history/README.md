...
| [2026-05-27](./history.20260527.md) | `malgn-noti-admin` Nuxt 3 + Nuxt UI v3 부트스트랩 + LNB(256px · 8그룹) + TopBar(64px) 셸 레이아웃 — `design_handoff_customer_detail` 정본 참조 + 첫 실 Nuxt 앱 프로덕션 배포(`https://malgn-noti-admin.pages.dev`, 이전 정적 placeholder 대체) |
